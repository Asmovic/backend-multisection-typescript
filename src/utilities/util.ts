...
export let statusMessage = {
    ...
    SERVER_BUSY: "Server is busy at the moment",
    RESOURCE_NOT_FOUND: "Resource not found"
};

export const statusResponseObjects = {
...
export const decryptPasswordAsync = (myPlaintextPassword: string, hash: string, callback: any) => {
